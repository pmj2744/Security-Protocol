...
const modules = [
  {
    title: '사용자 등록 / 인증서 발급',
    description: '사용자 공개키 등록 및 X.509 인증서 발급 기능을 수행합니다.',
    href: '/cert-issue',
    status: '완료',          
    enabled: true,          
  },
      ...
      <section style={{ maxWidth: '800px', margin: '0 auto 40px auto', padding: '0 20px', width: '100%' }}>
        <div className="team-panel" style={{ padding: '10px 24px', background: 'transparent', borderRadius: 0, border: 'none', textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '20px' }}>
          ...
          <a 
            ...
            style={{ 
              display: 'inline-flex', alignItems: 'center', gap: '8px', padding: '10px 20px', backgroundColor: '#10b981', color: '#fff', borderRadius: '30px', fontSize: '13px', fontWeight: 'bold', textDecoration: 'none', boxShadow: '0 2px 4px rgba(16, 185, 129, 0.2)', transition: 'all 0.2s'
            }}
          >
             결과 보고서 확인하기 ↗
          </a>
